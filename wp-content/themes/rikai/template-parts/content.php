...
<article id="post-<?php the_ID(); ?>" <?php post_class(''); ?>>
    ...
    <?php //endif;?>
    <?php if( uni_option('blogpost-single-time-view') == true ) : ?>
    ...
    <?php if( uni_option('blogpost-single-sharepost') == true ) : ?>
    ...
    <?php endif;?>
    <?php
    if( uni_option('blogpost-single-navipost') == true && ( ! empty( get_next_post() ) || ! empty( get_previous_post() ) ) ) :
    ...
    <?php 
    if( uni_option('blogpost-single-relatedpost') == true ) {
        // $blogpost_layout     = uni_option('blogpost-layout');
        $blogpost_layout     = 3;
        $posts_per_page     = uni_option('blogpost-number-post-related');
